...
function mh_magazine_lite_register_widgets() {
	...
	register_widget('iBinex_related_posts_large');
	register_widget('iBinex_editors_pick');
}
...
require_once('widgets/iBinex-related-large.php');
require_once('widgets/iBinex-editors-pick.php');
?>